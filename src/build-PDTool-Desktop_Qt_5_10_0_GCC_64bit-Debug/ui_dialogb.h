...
public:
    ...
    void setupUi(QDialog *Dialogb)
    {
        ...
        Dialogb->resize(539, 446);
        label_title = new QLabel(Dialogb);
        label_title->setObjectName(QStringLiteral("label_title"));
        label_title->setGeometry(QRect(240, 10, 81, 16));
        QFont font;
        font.setPointSize(11);
        label_title->setFont(font);
        label_image = new QLabel(Dialogb);
        label_image->setObjectName(QStringLiteral("label_image"));
        label_image->setGeometry(QRect(10, 80, 521, 331));
        ...
        pushButton_close_image->setGeometry(QRect(230, 410, 89, 25));
        label_time = new QLabel(Dialogb);
        label_time->setObjectName(QStringLiteral("label_time"));
        label_time->setGeometry(QRect(240, 30, 41, 31));
        QFont font1;
