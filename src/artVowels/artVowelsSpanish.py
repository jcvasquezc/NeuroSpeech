...
def articulationVowels(audioA, audioE, audioI, audioO, audioU, path_base):
    ...
    plt.plot([mF1a, mF1i, mF1u, mF1a], [mF2a, mF2i, mF2u, mF2a], linewidth=3, c='g', label='Paciente')

    plt.plot([775, 373, 350, 775], [1335, 2325, 500, 1335], linewidth=3, c='k', label='Referencia')
    ...
    plt.scatter(F1u, F2u, c='k', alpha=0.5, marker='o', s=100, label='/u/')
    plt.plot([mF1a, mF1e, mF1i, mF1u, mF1o, mF1a], [mF2a, mF2e, mF2i, mF2u, mF2o, mF2a], linewidth=3, c='g', label='Paciente')
    plt.plot([775, 490, 373, 350, 523, 775], [1335, 2074, 2325, 500, 1020, 1335], linewidth=3, c='k', label='Referencia')
