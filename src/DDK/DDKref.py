# -*- coding: utf-8 -*-
"""
Created on Fri Apr 14 10:34:47 2017
...
def DDK(audio, path_base):
    ...
    refh=np.asarray([Hz2semitones(39**2),  39, 9.4, 10.8, 18.8, 2.5, 521, 347, 0.6, 547, 271])
    refl=np.asarray([Hz2semitones(22**2),  22, 7.0, 9.0, 16.9, 1.7, 292, 209, 0.3, 211, 6])
    ...
    plot_radar(dataradar, refh, refl, names, 'DDK', path_base+'DDKradar.png')    
